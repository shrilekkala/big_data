...
```
And in fact we observe that 4/5 LHS actors appearing in the pairwise actor-cast association rules with at least 0.01% support and 10% confidence for RHS actor Kevin Bacon, are in the top 6 positive coefficients from the logistic regression.
